...
export function buildDraftPrompt(ctx: DraftContext): string {
	...
	return [
		...
		"FACTS RULE: use ONLY the facts below. Never invent a price, discount, date, feature or promise. If the reply needs a fact you do not have, write [CHECK: what is needed] in the draft and add it to checks.",
